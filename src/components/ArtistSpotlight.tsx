...
const ArtistSpotlight: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-l from-background/60 to-background/40 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-primary-dark/6 rounded-full blur-3xl animate-float" style={{ animationDelay: '4s' }}></div>
      <div className="absolute top-12 left-1/4 w-48 h-48 bg-primary-glow/6 rounded-full blur-2xl animate-float" style={{ animationDelay: '1s' }}></div>
      <div className="absolute bottom-12 right-1/4 w-56 h-56 bg-primary/7 rounded-full blur-3xl animate-float" style={{ animationDelay: '3s' }}></div>
